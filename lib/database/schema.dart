...
class Schema {
  ...
  static Future<void> seedDefaultCategories(Database db) async {
    ...
    final defaultCategories = [
      Category(id: uuid.v4(), name: 'Shelter', icon: 'tent'),
      Category(id: uuid.v4(), name: 'Sleep System', icon: 'bed'),
      Category(id: uuid.v4(), name: 'Clothing', icon: 'shirt'),
      Category(id: uuid.v4(), name: 'Footwear', icon: 'shoe-prints'),
      Category(id: uuid.v4(), name: 'Navigation', icon: 'compass'),
      Category(id: uuid.v4(), name: 'Lighting', icon: 'lightbulb'),
      Category(id: uuid.v4(), name: 'Cooking', icon: 'fire'),
      Category(id: uuid.v4(), name: 'Food & Water', icon: 'utensils'),
      Category(id: uuid.v4(), name: 'First Aid', icon: 'first-aid'),
      Category(id: uuid.v4(), name: 'Tools & Repair', icon: 'wrench'),
      Category(id: uuid.v4(), name: 'Electronics', icon: 'plug'),
      Category(id: uuid.v4(), name: 'Packs & Bags', icon: 'person-hiking'),
      Category(id: uuid.v4(), name: 'Climbing', icon: 'mountain'),
      Category(id: uuid.v4(), name: 'Snow Sports', icon: 'snowflake'),
      Category(id: uuid.v4(), name: 'Water Sports', icon: 'water'),
      Category(id: uuid.v4(), name: 'Hygiene', icon: 'soap'),
      Category(id: uuid.v4(), name: 'Safety', icon: 'shield'),
      Category(id: uuid.v4(), name: 'Miscellaneous', icon: 'ellipsis'),
    ];
